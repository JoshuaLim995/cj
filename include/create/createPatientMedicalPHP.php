...
if(isset($_SESSION['userID'])){
	...
	if(isset($_GET["ID"])){
		...
		if (isset($_POST['next'])) {
			...
			$query = "INSERT INTO medical (Date, Nurse_ID, Patient_ID, Blood_Pressure, Heart_Rate, Sugar_Level, Temperature, Description, Other) 
			VALUES ('$Date', '$Nurse_ID', '$Patient_ID', '$Blood_Pressure', '$Heart_Rate', '$Sugar_Level', '$Temperature', '$Description', '$Other')";
